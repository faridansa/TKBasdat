$(document).ready(function() {
	 if(sessionStorage.getItem("username") === "admin") {
        ...
        $("#login-reg-nav").remove();
        var logout = "<li><a href= \"#\" id= \"logout-btn\">Log Out</a></li>";
        var pageuser = "<li id=\"sirima\" class=\"dropdown \"><a href=\"#\">Informasi SIRIMA <i class=\"fa fa-angle-down\"></i></a> <ul role=\"menu\" class=\"sub-menu\"><li> <a href= \"link-buat-pendaftaran\">Buat Pendaftaran</a> </li><li> <a href= \"riwayatdaftar.php\">Riwayat Pendaftaran</a></li><li> <a href= \"kartuujian.php\">Kartu Ujian</a> </li><li> <a href= \"hasilseleksi.php\">Hasil Seleksi</a> </li><li>";
