$(document).ready(function() {
	 if(sessionStorage.getItem("username") === "admin") {
        ...
        $("#login-reg-nav").remove();
        var logout = "<li><a href= \"#\" id= \"logout-btn\">Log Out</a></li>";
        var pageuser = "<li class=\"dropdown\"><a href=\"#\">Informasi SIRIMA <i class=\"fa fa-angle-down\"></i></a> <ul role=\"menu\" class=\"sub-menu\"><li> <a href= \"daftar/semas1.html\">Buat Pendaftaran</a> </li><li> <a href= \"lihat/riwayatdaftar.html\">Riwayat Pendaftaran</a></li><li> <a href= \"lihat/kartuujian.html\">Kartu Ujian</a> </li><li> <a href= \"lihat/hasilseleksi.html\">Hasil Seleksi</a> </li><li>";
