$(document).ready(function() {
     if(sessionStorage.getItem("username") === "admin") {
        ...
        var pageadmin = "<li class=\"dropdown\"><a href=\"#\">Laman Admin <i class=\"fa fa-angle-down\"></i></a> <ul role=\"menu\" class=\"sub-menu\"><li><a href= \"form_rekapJenjang\">Rekap Pendaftaran</a></li><li><a href= \"form_rekapJenjang\">Daftar Pelamar</a></li></ul></li>";
