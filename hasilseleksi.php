            ...
            <div class="row">
                <form class="col s12" id="inputid">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <input type="hidden" id="textb" value="Lihat" name="command">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("#inputid").submit(function(e){
                    var url = './hasilseleksiFungsi.php';
                    $.ajax({
                        type: "POST",
                        url: url,
                        ...
                        if (sizeJSON === 7) {
                        ...
                        } else if(sizeJSON === 5 && $datafetched[2] === "TIDAK LULUS" ) {
                           content = `<tbody><tr><td>Id Pendaftaran</td><td>${datafetched[0]}</td></tr><tr><td>Nama Lengkap </td><td>${datafetched[1]}</td></tr><tr><td>Status </td><td>TIDAK LULUS</td></tr></tbody>`;
                            ...
                            content = `<tbody><tr><td>Id Pendaftaran</td><td>${datafetched[0]}</td></tr><tr><td>Nama Lengkap </td><td>${datafetched[1]}</td></tr><tr><td>Status </td><td>BELUM LULUS</td></tr></tbody>`;
                        }
