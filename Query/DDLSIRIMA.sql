...
CREATE TABLE LOKASI_JADWAL (
  ...
  FOREIGN KEY (kota, tempat) REFERENCES LOKASI_UJIAN
  ON DELETE CASCADE ON UPDATE CASCADE
);

\d AKUN
\d PERIODE_PENERIMAAN
\d JADWAL_PENTING
\d JENJANG
\d PROGRAM_STUDI
\d PENERIMAAN_PRODI
...
\d REKOMENDASI
\d PENDAFTARAN_SEMAS
\d PENDAFTARAN_SEMAS_SARJANA
\d PENDAFTARAN_SEMAS_PASCASARJANA
\d PEMBAYARAN
\d LOKASI_UJIAN
\d RUANG_UJIAN
\d PENGAWAS
...
========== EDIT CONSTRAINTS TAHAP II ==============
ALTER TABLE PERIODE_PENERIMAAN ADD COLUMN status_aktif BOOLEAN;
ALTER TABLE PERIODE_PENERIMAAN ALTER COLUMN status_aktif SET NOT NULL;
ALTER TABLE PERIODE_PENERIMAAN DROP COLUMN status_aktif;

ALTER TABLE PENDAFTARAN ALTER COLUMN status_lulus DROP NOT NULL;
ALTER TABLE PENDAFTARAN ALTER COLUMN status_lulus DROP DEFAULT;
ALTER TABLE PENDAFTARAN ALTER COLUMN status_verifikasi DROP NOT NULL;
ALTER TABLE PENDAFTARAN ALTER COLUMN status_verifikasi DROP DEFAULT;

ALTER TABLE PENDAFTARAN_PRODI ALTER COLUMN status_lulus DROP NOT NULL;

ALTER TABLE PENDAFTARAN_SEMAS ALTER COLUMN status_hadir DROP NOT NULL;
ALTER TABLE PENDAFTARAN_SEMAS ALTER COLUMN nilai_ujian DROP NOT NULL;
ALTER TABLE PENDAFTARAN_SEMAS ALTER COLUMN no_kartu_ujian DROP NOT NULL;


========== EDIT SCHEMA TAHAP III ==============
ALTER TABLE LOKASI_UJIAN DROP COLUMN nomor_periode;
ALTER TABLE LOKASI_UJIAN DROP COLUMN tahun_periode;
ALTER TABLE LOKASI_UJIAN DROP COLUMN jenjang;
ALTER TABLE LOKASI_UJIAN DROP COLUMN waktu_awal;

SELECT * FROM LOKASI_UJIAN;
